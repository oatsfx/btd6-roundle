...
const Footer: React.FC = () => {
  return (
    <footer className="sticky top-[100vh] flex flex-col gap-2 mt-12 p-12 items-center px-24 text-center backdrop-blur-lg data-[menu-open=true]:backdrop-blur-xl backdrop-saturate-150 bg-background/70">
      ...
      <div className="flex flex-col gap-2 items-center pt-6 opacity-40">
        ...
        <a href="https://github.com/oatsfx/btd6-roundle" target="_blank">
          <FaGithub />
        </a>
      </div>
    </footer>
